...
namespace ParkingApp.Controllers
{
    public class SpacesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.spaces.Include(s => s.User);
        ...
        public async Task<IActionResult> Create([Bind("id,Address,Local_Govt,Status,No_Slot,Open_Time,Close_Time,Daily_Parking,Weekly_Parking,Monthly_Parking,Parking_Desc")] Space space)
        {
